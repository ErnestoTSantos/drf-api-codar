...
class TestSerializerScheduling(APITestCase):
    ...
    def test_validate_date_time_when_day_is_sunday(self):
        ...
        assert response.status_code == 400
        assert data == {
            "date_time": ["Infelizmente o estabelecimento não trabalha aos domingos!"]
        }  # noqa:E501
    ...
    def test_validate_date_time_when_is_lunch_time(self):
        ...
        assert response.status_code == 400
        assert data == {
            "date_time": ["Os funcionários estão no horário de almoço!"]
        }  # noqa:E501
    ...
    def test_validate_date_time_when_time_is_earlier_than_opening_time(self):
        ...
        assert response.status_code == 400
        assert data == {
            "date_time": ["O estabelecimento abre apenas às 9h!"]
        }  # noqa:E501

    def test_validate_date_time_when_time_is_more_latest_than_closing_time(
        self,
    ):  # noqa:E501
        User.objects.create(
            email="ernesto.terra2003@gmail.com", username="Ernesto", password="12345"
    ...
    def test_validate_client_name_characters(self):
        ...
        assert response.status_code == 400
        assert data == {
            "client_name": ["O nome do cliente precisa ter 7 ou mais caracteres!"]
        }  # noqa:E501
    ...
    def test_validate_client_name_space_for_last_name(self):
        ...
        assert response.status_code == 400
        assert data == {
            "client_name": ["O cliente precisa ter um sobrenome!"]
        }  # noqa:E501
    ...
    def test_validate_client_phone_characters(self):
        ...
        assert response.status_code == 400
        assert data == {
            "client_phone": ["O número de telefone precisa ter no mínimo 8 digitos!"]
        }  # noqa:E501
    ...
    def test_validate_date_time_horary_is_invalid(self):
        ...
        post_response = self.client.post(
            "/api/scheduling/?establishment=Ruby barber shop", scheduling_request
        )  # noqa:E501
        data = json.loads(post_response.content)

        assert patch.status_code == 200
        assert data == {
            "date_time": ["Infelizmente o horário selecionado está indisponível!"]
        }  # noqa:E501
