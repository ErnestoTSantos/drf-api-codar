...
class TestingReturnedName(APITestCase):
    ...
    def test_returned_name_in_address(self):
        establishment = Establishment.objects.create(name='Python Barber shop')
        address = Address.objects.create(establishment=establishment, cep='88901-104', city='Araranguá', district='Cidade Alta', street='Alameda Antônio Alves da Silva')  # noqa:E501

        assert str(address) == 'Python Barber shop -> Alameda Antônio Alves da Silva'  # noqa:E501
