...
class Scheduling(models.Model):
    ...
    states = models.CharField(
        "Estados do elemento", max_length=4, choices=ACTION_STATES, default="NCNF"
    )
...
class Establishment(models.Model):
    name = models.CharField("Nome do estabelecimento", max_length=100, unique=True)
...
class Address(models.Model):
    ...
    complement = models.CharField("Complement", max_length=50, blank=True, null=True)
